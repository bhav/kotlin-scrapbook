...
fun main(args: Array<String>) {
    ...
    println(immutableMap.toSortedMap()) //sorts by key
    ...
    println(cars.find { it.year > 2014 }) //gets first only
    ...
    val yearsList = immutableMap.map { it.value.year }
    ...
    val filteredMap = mutableMap.filter { it.value.color == "silver" }
